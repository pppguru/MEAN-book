 ...
 * NOTE: above plugin uses jquery code. We omitted jquery code, and replaced it with pure angular code because of some webpack build errors.
 */
'use strict';

import angular from 'angular';

export default angular.module('hl.sticky', [])
