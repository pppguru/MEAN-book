...
gulp.task('copy:i18n', () => {
     return gulp.src(['./node_modules/angular-i18n/angular-locale_en-us.js', './node_modules/angular-i18n/angular-locale_no-no.js'
     ], {dot: true}).pipe(gulp.dest(`${clientPath}/components/translate/i18n`));
});
gulp.task('copy:i18n:dist', () => {
     return gulp.src(['./node_modules/angular-i18n/angular-locale_en-us.js', './node_modules/angular-i18n/angular-locale_no-no.js'
     ], {dot: true}).pipe(gulp.dest(`${paths.dist}/client/components/translate/i18n`));
});
gulp.task('copy:translations', () => {
     return gulp.src([`${clientPath}/components/translate/resources/*.*`])
          .pipe(gulp.dest(`${paths.dist}/client/components/translate/resources/`));
});

gulp.task('copy:certifications', () => {
     return gulp.src([`${serverPath}/encryption/*.*`])
          .pipe(gulp.dest(`${paths.dist}/server/encryption/`));
});

gulp.task('copy:ebextension', () => {
     return gulp.src([`${serverPath}/.ebextensions/*.*`])
          .pipe(gulp.dest(`${paths.dist}/.ebextensions/`));
});
